...
const { handlers, auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    ...
    providers: [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].providers.filter((p)=>p.id !== "credentials"),
        {
            ...
            async authorize (credentials) {
                const validatedFields = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
async function POST(req) {
    try {
        ...
        for (const [subjectKey, data] of Object.entries(submissionsBySubject)){
            ...
            const subject = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subject.upsert({
                where: {
                    nameEn: displayEng
                },
                update: {},
                create: {
                    nameEn: displayEng,
                    nameAr: subjectKey === "math" ? "الرياضيات" : subjectKey === "physics" ? "الفيزياء" : subjectKey === "biology" ? "الأحياء" : subjectKey === "chemistry" ? "الكيمياء" : subjectKey === "english" ? "اللغة الإنجليزية" : displayEng,
                    isEnabled: true
                }
            });
            ...
            let aiAnalysis;
            try {
                aiAnalysis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["processAIRequest"])(prompt, locale);
            } catch (aiError) {
            ...
            const submission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.create({
                data: {
                    userId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cd0f7b6._.js.map
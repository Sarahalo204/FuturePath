...
async function GET() {
    try {
        ...
        // 1. Total Students
        const totalStudents = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.count({
            where: {
                role: "STUDENT"
            }
        });
        // 2. Total Quizzes Taken (Submissions)
        const totalQuizzes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.count();
        ...
        const subjectStats = subjects.map((s)=>{
            const avg = s.submissions.length > 0 ? s.submissions.reduce((acc, curr)=>acc + curr.score, 0) / s.submissions.length : 0;
            return {
                id: s.id,
                nameEn: s.nameEn,
                nameAr: s.nameAr,
        ...
        const challenging = [
            ...subjectStats
        ].filter((s)=>s.avg > 0).sort((a, b)=>a.avg - b.avg)[0] || null;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            totalStudents,
            totalQuizzes,
            subjectStats,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e37f659b._.js.map
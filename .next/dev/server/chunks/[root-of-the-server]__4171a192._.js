...
async function GET(req) {
    try {
        ...
        const learningPaths = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].learningPath.findFirst({
            where: {
                userId,
                ...subjectId ? {
                    subjectId
        ...
        const latestSubmission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].submission.findFirst({
            where: {
                userId,
                ...subjectId ? {
                    subjectId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4171a192._.js.map
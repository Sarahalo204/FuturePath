...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-12 max-w-5xl">
            <header>
                <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">{t("settings")}</h1>
                <p className="text-slate-500 font-medium">Configure global system parameters and monitor health.</p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="glass-panel p-8 bg-white/80 space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-3">
                            <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Active Intelligence Model</label>
                            <select
                                value={model}
                        ...
                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-start gap-3">
                            ...
                            <p className="text-xs font-medium text-slate-500 leading-relaxed">
                                System will automatically failover to fallback models if primary latency exceeds 3.5s.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            {isSaving ? "Saving..." : "Apply AI Policies"}
                        </button>
                    </div>
                </div>
                ...
                <div className="glass-panel p-8 bg-white/80 space-y-8">
                        ...
                        {[
                            ...
                            <div key={node.name} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-[10px] font-black text-emerald-600 uppercase tracking-tighter">Operational</span>
                    ...
                    <div className="pt-4 flex items-center gap-2 text-slate-400 italic text-xs font-medium border-t border-slate-100">
                        <span>Last scan: Today at 07:12:49 PM</span>
                    </div>
                </div>
            </div>
            ...
            <div className="glass-panel p-8 bg-slate-900 text-white border-none space-y-8 shadow-2xl shadow-slate-900/10">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-black tracking-tight">Global Language & Locale</h2>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Default Locale</p>
                        <p className="text-lg font-bold">English (UK)</p>
                    </div>
                    <div className="space-y-2">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Secondary Locale</p>
                        <p className="text-lg font-bold">Arabic (MENA)</p>
                    </div>
                    <div className="space-y-2">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">RTL Optimization</p>
                        <div className="flex items-center gap-2">
